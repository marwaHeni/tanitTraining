...
public class MailServiceIT {
    ...
    @Autowired
    private MyWayProperties myWayProperties;
    ...
    public void setup() {
        ...
        mailService = new MailService(myWayProperties, javaMailSender, messageSource, templateEngine);
    }
    ...
    public void testSendEmail() throws Exception {
        ...
        assertThat(message.getFrom()[0].toString()).isEqualTo(myWayProperties.getMail().getFrom());
